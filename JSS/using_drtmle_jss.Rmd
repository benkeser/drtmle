...
overfitting the initial nuisance regressions. While the layer of
cross-validation built into super learning attempts to guard against
overfitting, there are no guarantees in finite samples. To definitively avoid
such overfitting, one can use cross-validated estimates of the nuisance
...
option, as shown in the code below, where we continue on with the multi-level
treatment example.
...
estimate of the OR, options related to the OR are omitted. We demonstrate below,
while continuing with the multi-level treatment example.
