...
\texttt{drtmle} is fully equipped to handle treatments with an arbitrary number of
discrete values as well. Suppose that $A$ assumes values in a set $\mathcal{A}$
of limited cardinality, the PS regression estimation is modified to ensure that
\begin{equation*}
