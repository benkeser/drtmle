...
of the population-level effect of a treatment may have large bias.
...
(`SL.glm`), a generalized additive model (`SL.gam`, which utilizes the `gam`
package [@gamPackage]) and an unadjusted generalized linear model (`SL.mean`).
...
library(parallel)
library(snow) # for SOCK-tyep clusters
